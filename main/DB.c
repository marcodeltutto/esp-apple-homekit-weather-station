...
const HAPFloatCharacteristic TemperatureCharacteristic = {
    ...
    .constraints = { .minimumValue = -40, .maximumValue = 80, .stepValue = 0.1 },
...
const HAPFloatCharacteristic HumidityCharacteristic = {
    ...
    .constraints = { .minimumValue = 0, .maximumValue = 100, .stepValue = 0.1 },
...
const HAPUInt8Characteristic AirQualityCharacteristic = {
    ...
    .properties = { .readable = true,
                    ...
                    .ble = { .supportsBroadcastNotification = true,
                             ...
                             .writableWithoutSecurity = false } },
    .units = kHAPCharacteristicUnits_None,
    .constraints = { .minimumValue = 0, .maximumValue = 5, .stepValue = 1 },
